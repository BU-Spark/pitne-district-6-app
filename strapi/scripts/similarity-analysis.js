 ...
 * 
 * Usage: 
 * - Find similar locations: node scripts/similarity-analysis.js similar <locationId> [limit]
 * - Compare two locations: node scripts/similarity-analysis.js compare <locationId1> <locationId2>
 * - Analyze embedding quality: node scripts/similarity-analysis.js analyze
 */
...
if (require.main === module) {
  ...
  if (args.length === 0) {
    console.log('Usage:');
    console.log('  Find similar: node scripts/similarity-analysis.js similar <locationId> [limit]');
    console.log('  Compare two: node scripts/similarity-analysis.js compare <locationId1> <locationId2>');
    console.log('  Analyze quality: node scripts/similarity-analysis.js analyze');
    process.exit(1);
  }
